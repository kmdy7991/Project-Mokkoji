package com.ssafy.mokkoji.global.jwt;


import com.ssafy.mokkoji.global.config.ExpireTime;
import com.ssafy.mokkoji.users.dto.UserResponseDto;
import com.ssafy.mokkoji.users.enums.Role;
...
//    }
    ...
    // Authentication(유저 정보)를 가지고 AccessToken, RefreshToken 을 생성
    ...
    //JWT 토큰을 복호화해서 토큰에 들어있는 정보를 꺼낸다
    ...
    // Request Header 에서 bearer 뺀 토큰 추출
