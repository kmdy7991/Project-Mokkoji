package com.ssafy.mokkoji.chat.controller;

import com.ssafy.mokkoji.chat.dto.request.MessageDto;
import com.ssafy.mokkoji.chat.dto.response.MessageResponse;
import com.ssafy.mokkoji.chat.service.ChatService;
...
// 정답 확인
    ...
    static boolean findWord(String origin, String find) {
        ...
        while (originIndex < originLen) {
            ...
            originIndex += Math.max(table[origin.charAt(originIndex)], findLen - findIndex);
        }
        return false;
    }
